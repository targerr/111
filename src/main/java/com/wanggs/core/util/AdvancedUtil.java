...
import com.wanggs.core.*;
import com.wanggs.core.message.Article;
import com.wanggs.core.message.Music;
...
public class AdvancedUtil {
    ...
    public static void main(String args[]) {
        // 获取接口访问凭证
        String accessToken = CommonUtil.getToken("wxf52b3d3e51c2cb9e", "a540a5072209f6b678b91f90be33b249").getAccessToken();
         ...
         * 下载多媒体文件
         */
        getMedia(accessToken, "N7xWhOGYSLWUMPzVcGnxKFbhXeD_lLT5sXxyxDGEsCzWIB2CcUijSeQOYjWLMpcn", "D:/download");
    }
}
