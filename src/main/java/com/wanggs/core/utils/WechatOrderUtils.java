...
import com.wanggs.core.beans.WechatOrder;
...
public class WechatOrderUtils {
    ...
    public static synchronized JSONObject createOrder(String detail, String desc, String openid, String ip, String goodSn, String orderSn, String amount, String type) {
       ...
       /* 公众号调起微信支付的时候，必须要有openID*/
        ...
        // 2、获取系统配置信息
        String wx_order = "https://api.mch.weixin.qq.com/pay/unifiedorder";//PropertiesUtil.getValue("wechat.properties", "wx_order");//获取统一下单接口地址
        String mchappid = "wxd898fcb01713c658";//PropertiesUtil.getValue("wechat.properties", "mchappid");// 商户appid
        String mchid = "1483469312";//PropertiesUtil.getValue("wechat.properties", "mchid");// 商户ID
        String wx_callback = "http://wanggss.nat300.top/index";//PropertiesUtil.getValue("wechat.properties", "wx_callback");// 获取微信支付回调接口
        String wx_key = "C5245D70627C1F8E9964D494B0735025";//PropertiesUtil.getValue("wechat.properties", "wx_key");//微信商户后台设置的key
